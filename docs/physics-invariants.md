...
landmarks by their circle radii while a shaped rock's corners reach past that (x`reach`), so a freshly generated pocket has its masonry keyed together at the corners on purpose.
